# -*- coding: utf-8 -*-
"""
Created on Thu Nov 12 14:06:40 2015
...
c1=ax13.pcolor(img1, norm=LogNorm(),cmap='seismic')
ax14.imshow(img2, origin = 'lower',aspect='auto') 
ax14.pcolor(img2, norm=LogNorm(),cmap='seismic')
ax10.imshow(img3, origin = 'lower',aspect='auto') 
ax10.pcolor(img3, norm=LogNorm(),cmap='seismic')
ax6.imshow(img4, origin = 'lower',aspect='auto') 
ax6.pcolor(img4, norm=LogNorm(),cmap='seismic')
ax15.imshow(img5, origin = 'lower',aspect='auto') 
ax15.pcolor(img5, norm=LogNorm(),cmap='seismic')
ax11.imshow(img6, origin = 'lower',aspect='auto') 
ax11.pcolor(img6, norm=LogNorm(),cmap='seismic')
ax7.imshow(img7, origin = 'lower',aspect='auto') 
ax7.pcolor(img7, norm=LogNorm(),cmap='seismic')
ax16.imshow(img8, origin = 'lower',aspect='auto') 
ax16.pcolor(img8, norm=LogNorm(),cmap='seismic')
ax12.imshow(img9, origin = 'lower',aspect='auto') 
ax12.pcolor(img9, norm=LogNorm(),cmap='seismic')
ax8.imshow(img10, origin = 'lower',aspect='auto') 
ax8.pcolor(img10, norm=LogNorm(),cmap='seismic')
ax4.imshow(img11, origin = 'lower',aspect='auto') 
ax4.pcolor(img11, norm=LogNorm(),cmap='seismic')
